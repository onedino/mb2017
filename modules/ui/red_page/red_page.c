...
//     gwinPrintf(Console_r, "%d\r\n ", (int)((float)m[1].speed_ref_krpm ));
     ...
     gwinPrintf(Console_r, "XXX  %5d\033t  ", distanceSum);
     gwinPrintf(Console_r, "YYY  %5d\033t\r\n", (int)yDistance);
     gwinPrintf(Console_r, "D_S  %4d\033t  ", M[4].SetPoint - redStateSet[targetPosition].shootspd);
     gwinPrintf(Console_r, "D_P  %4d\033t  ", getPitch() - redStateSet[targetPosition].pitch);
     gwinPrintf(Console_r, "D_R  %4d\033t  ", getRoll() - redStateSet[targetPosition].roll);
     gwinPrintf(Console_r, "D_X  %4d\033t  ", distanceSum - redStateSet[targetPosition].x);
