...
//  gwinSetFont(Console1_r, dejavu_sans_32_anti_aliased);
  ...
  gwinSetColor(Console5_r, Green);
  gwinSetBgColor(Console5_r, Red);
  gwinRedraw(Console5_r);
}
...
//     gwinPrintf(Console1_r, UIDrivingState_r[DrivingState]);
     ...
     gwinPrintf(Console_r, "XXX %4d\033t ", distanceSum);
     gwinPrintf(Console_r, "YYY %4d\033t\r\n", (int)yDistance);
//     gwinPrintf(Console_r, "D_S %4d\033t ", redStateSet[targetPosition].shootspd - M[4].SetPoint);
//     gwinPrintf(Console_r, "D_P %4d\033t ", redStateSet[targetPosition].pitch - getPitch());
...
//	oldENvalue = (int16_t)encoder1_2.delta_count[0];
     ...
     gwinPrintf(Console2_r, "TRGT VAL\r\n");
     gwinPrintf(Console2_r, "Pos: %d\r\n", redStateSet[targetPosition].id);
     gwinPrintf(Console2_r, "Pit: %d\r\n", redStateSet[targetPosition].pitch);
     gwinPrintf(Console2_r, "Rol: %d\r\n", redStateSet[targetPosition].roll);
     gwinPrintf(Console2_r, "Sht: %d\r\n", redStateSet[targetPosition].shootspd);
     gwinPrintf(Console2_r, "Xxx: %d\r\n", redStateSet[targetPosition].x);
     gwinPrintf(Console2_r, "Yyy: %d\r\n", redStateSet[targetPosition].y);
...
//     gwinPrintf(Console2_r, "LD : %d\n", line_y_r);
     ...
     gwinPrintf(Console3_r, "Ldis: %d\r\n", Ldisc);
	 gwinPrintf(Console3_r, "Rdis: %d\r\n", Rdisc);
	 gwinPrintf(Console3_r, "Cdis: %d\r\n", Cdisc);
	 gwinPrintf(Console3_r, "A6_R: %d\r\n", A6on);
	 gwinPrintf(Console3_r, "A7_L: %d\r\n", A7on);

     gwinClear(Console4_r);
     gwinPrintf(Console4_r, "D0: %d\r\n", debug_display[0]);
     gwinPrintf(Console4_r, "D1: %d\r\n", debug_display[1]);
     gwinPrintf(Console4_r, "D2: %d\r\n", debug_display[2]);
     gwinPrintf(Console4_r, "D3: %d\r\n", debug_display[3]);
     gwinPrintf(Console4_r, "D4: %d\r\n", debug_display[4]);
     gwinPrintf(Console4_r, "D5: %d\r\n", debug_display[5]);
     gwinPrintf(Console4_r, "D6: %d\r\n", debug_display[6]);
     gwinPrintf(Console4_r, "D7: %d\r\n", debug_display[7]);
     gwinPrintf(Console4_r, "D8: %d\r\n", debug_display[8]);
     gwinPrintf(Console4_r, "D9: %d\r", debug_display[9]);
...
//     gwinPrintf(Console3_r, "stage: %d\r\n", stage_r);
	...
	gwinClear(Console5_r);
	gwinPrintf(Console5_r, "RED FIELD\r\n");
	if(encoder1_2.Alive <= 0) gwinPrintf(Console5_r, "EN GG\r\n");
	if(M[0].timeout <= 0) gwinPrintf(Console5_r, "M0 GG\r\n");
	if(M[1].timeout <= 0) gwinPrintf(Console5_r, "M1 GG\r\n");
	if(M[2].timeout <= 0) gwinPrintf(Console5_r, "M2 GG\r\n");
	if(M[3].timeout <= 0) gwinPrintf(Console5_r, "M3 GG\r\n");
	if(M[4].timeout <= 0) gwinPrintf(Console5_r, "M4 GG\r\n");
	if(M[5].timeout <= 0) gwinPrintf(Console5_r, "M5 GG\r\n");
	if(M[6].timeout <= 0) gwinPrintf(Console5_r, "M6 GG\r\n");
	if(Servo1.Alive <= 0) gwinPrintf(Console5_r, "S1 GG\r\n");
//	if(airBoard.Alive <= 0) gwinPrintf(Console5_r, "AIR GG%d\r\n");
