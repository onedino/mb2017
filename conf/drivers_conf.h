...
/*BTD*/
#define DRIVER_USBH_USE_BTD                TRUE
#define DRIVER_USBHBTD_MAX_INSTANCES         1
...
#define USBHDS4_DEBUG_ENABLE_WARNINGS  FALSE
#define USBHDS4_DEBUG_ENABLE_ERRORS    FALSE

#define USBHBTD_DEBUG_ENABLE_TRACE     FALSE
#define USBHBTD_DEBUG_ENABLE_INFO      FALSE
#define USBHBTD_DEBUG_ENABLE_WARNINGS  FALSE
#define USBHBTD_DEBUG_ENABLE_ERRORS    FALSE
